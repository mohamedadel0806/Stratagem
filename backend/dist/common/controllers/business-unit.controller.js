...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all business units' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'List of business units',
        type: [business_unit_entity_1.BusinessUnit],
    }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get business unit by ID' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
