...
], RequirementQueryDto.prototype, "search", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: compliance_requirement_entity_1.RequirementStatus, description: 'Filter by status' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(compliance_requirement_entity_1.RequirementStatus),
    __metadata("design:type", String)
], RequirementQueryDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by framework ID' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsUUID)('4', { message: 'frameworkId must be a valid UUID' }),
    __metadata("design:type", String)
], RequirementQueryDto.prototype, "frameworkId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by category' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], RequirementQueryDto.prototype, "category", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Number)
], RequirementQueryDto.prototype, "limit", void 0);
