...
exports.SOPQueryDto = SOPQueryDto;
__decorate([
...
], SOPQueryDto.prototype, "page", void 0);
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], SOPQueryDto.prototype, "limit", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: sop_entity_1.SOPStatus, description: 'Filter by status' }),
    (0, class_validator_1.IsEnum)(sop_entity_1.SOPStatus),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], SOPQueryDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: sop_entity_1.SOPCategory, description: 'Filter by category' }),
    (0, class_validator_1.IsEnum)(sop_entity_1.SOPCategory),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], SOPQueryDto.prototype, "category", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by owner ID' }),
    (0, class_validator_1.IsUUID)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], SOPQueryDto.prototype, "owner_id", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Search in title, description, and content' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], SOPQueryDto.prototype, "search", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Sort field and order (e.g., "created_at:DESC" or "title:ASC")' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], SOPQueryDto.prototype, "sort", void 0);
//# sourceMappingURL=sop-query.dto.js.map