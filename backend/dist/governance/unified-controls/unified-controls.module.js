...
const asset_control_controller_1 = require("./asset-control.controller");
...
exports.UnifiedControlsModule = UnifiedControlsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [unified_controls_controller_1.UnifiedControlsController, control_tests_controller_1.ControlTestsController, asset_control_controller_1.AssetControlController],
        providers: [
            ...
            asset_control_service_1.AssetControlService,
        ],
        exports: [
            unified_controls_service_1.UnifiedControlsService,
            control_asset_mapping_service_1.ControlAssetMappingService,
