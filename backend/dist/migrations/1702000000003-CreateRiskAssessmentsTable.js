...
exports.CreateRiskAssessmentsTable1702000000003 = void 0;
const typeorm_1 = require("typeorm");
class CreateRiskAssessmentsTable1702000000003 {
    ...
    `);
        ...
        await queryRunner.createForeignKey('risk_assessments', new typeorm_1.TableForeignKey({
            columnNames: ['risk_id'],
        ...
        await queryRunner.createIndex('risk_assessments', new typeorm_1.TableIndex({ columnNames: ['risk_id'] }));
        await queryRunner.createIndex('risk_assessments', new typeorm_1.TableIndex({ columnNames: ['assessment_type'] }));
        await queryRunner.createIndex('risk_assessments', new typeorm_1.TableIndex({ columnNames: ['assessment_date'] }));
        await queryRunner.createIndex('risk_assessments', new typeorm_1.TableIndex({ columnNames: ['risk_level'] }));
        await queryRunner.createIndex('risk_assessments', new typeorm_1.TableIndex({
...
exports.CreateRiskAssessmentsTable1702000000003 = CreateRiskAssessmentsTable1702000000003;
//# sourceMappingURL=1702000000003-CreateRiskAssessmentsTable.js.map