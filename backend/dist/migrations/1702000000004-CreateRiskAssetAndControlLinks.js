...
exports.CreateRiskAssetAndControlLinks1702000000004 = void 0;
const typeorm_1 = require("typeorm");
class CreateRiskAssetAndControlLinks1702000000004 {
    ...
    `);
        ...
        await queryRunner.createForeignKey('risk_asset_links', new typeorm_1.TableForeignKey({
            columnNames: ['risk_id'],
        ...
        await queryRunner.createIndex('risk_asset_links', new typeorm_1.TableIndex({ columnNames: ['risk_id'] }));
        await queryRunner.createIndex('risk_asset_links', new typeorm_1.TableIndex({ columnNames: ['asset_type', 'asset_id'] }));
        await queryRunner.query(`
    ...
    `);
        ...
        await queryRunner.createForeignKey('risk_control_links', new typeorm_1.TableForeignKey({
            columnNames: ['risk_id'],
            referencedColumnNames: ['id'],
            referencedTableName: 'risks',
            onDelete: 'CASCADE',
        ...
        await queryRunner.createIndex('risk_control_links', new typeorm_1.TableIndex({ columnNames: ['risk_id'] }));
        await queryRunner.createIndex('risk_control_links', new typeorm_1.TableIndex({ columnNames: ['control_id'] }));
        await queryRunner.createIndex('risk_control_links', new typeorm_1.TableIndex({ columnNames: ['effectiveness_rating'] }));
        await queryRunner.query(`
...
exports.CreateRiskAssetAndControlLinks1702000000004 = CreateRiskAssetAndControlLinks1702000000004;
//# sourceMappingURL=1702000000004-CreateRiskAssetAndControlLinks.js.map