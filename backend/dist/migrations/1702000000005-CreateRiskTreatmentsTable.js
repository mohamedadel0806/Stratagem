...
exports.CreateRiskTreatmentsTable1702000000005 = void 0;
const typeorm_1 = require("typeorm");
class CreateRiskTreatmentsTable1702000000005 {
    ...
    `);
        ...
        await queryRunner.createForeignKey('risk_treatments', new typeorm_1.TableForeignKey({
            columnNames: ['risk_id'],
        ...
        await queryRunner.createForeignKey('treatment_tasks', new typeorm_1.TableForeignKey({
        ...
        await queryRunner.createIndex('risk_treatments', new typeorm_1.TableIndex({ columnNames: ['risk_id'] }));
        await queryRunner.createIndex('risk_treatments', new typeorm_1.TableIndex({ columnNames: ['treatment_id'] }));
        await queryRunner.createIndex('risk_treatments', new typeorm_1.TableIndex({ columnNames: ['status'] }));
        await queryRunner.createIndex('risk_treatments', new typeorm_1.TableIndex({ columnNames: ['treatment_owner_id'] }));
        await queryRunner.createIndex('risk_treatments', new typeorm_1.TableIndex({ columnNames: ['target_completion_date'] }));
        await queryRunner.createIndex('risk_treatments', new typeorm_1.TableIndex({ columnNames: ['priority'] }));
        await queryRunner.createIndex('treatment_tasks', new typeorm_1.TableIndex({ columnNames: ['treatment_id'] }));
        await queryRunner.createIndex('treatment_tasks', new typeorm_1.TableIndex({ columnNames: ['status'] }));
        await queryRunner.query(`
...
exports.CreateRiskTreatmentsTable1702000000005 = CreateRiskTreatmentsTable1702000000005;
//# sourceMappingURL=1702000000005-CreateRiskTreatmentsTable.js.map