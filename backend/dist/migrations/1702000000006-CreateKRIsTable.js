...
exports.CreateKRIsTable1702000000006 = void 0;
const typeorm_1 = require("typeorm");
class CreateKRIsTable1702000000006 {
    ...
    `);
        ...
        await queryRunner.createForeignKey('kris', new typeorm_1.TableForeignKey({
        ...
        await queryRunner.createForeignKey('kri_measurements', new typeorm_1.TableForeignKey({
            columnNames: ['kri_id'],
            referencedColumnNames: ['id'],
        ...
        await queryRunner.createForeignKey('kri_risk_links', new typeorm_1.TableForeignKey({
            columnNames: ['kri_id'],
            referencedColumnNames: ['id'],
            referencedTableName: 'kris',
            onDelete: 'CASCADE',
        ...
        await queryRunner.createIndex('kris', new typeorm_1.TableIndex({ columnNames: ['kri_id'] }));
        await queryRunner.createIndex('kris', new typeorm_1.TableIndex({ columnNames: ['category_id'] }));
        await queryRunner.createIndex('kris', new typeorm_1.TableIndex({ columnNames: ['current_status'] }));
        await queryRunner.createIndex('kris', new typeorm_1.TableIndex({ columnNames: ['is_active'] }));
        await queryRunner.createIndex('kris', new typeorm_1.TableIndex({ columnNames: ['kri_owner_id'] }));
        await queryRunner.createIndex('kri_measurements', new typeorm_1.TableIndex({ columnNames: ['kri_id'] }));
        await queryRunner.createIndex('kri_measurements', new typeorm_1.TableIndex({ columnNames: ['measurement_date'] }));
        await queryRunner.createIndex('kri_measurements', new typeorm_1.TableIndex({ columnNames: ['kri_id', 'measurement_date'] }));
        await queryRunner.createIndex('kri_risk_links', new typeorm_1.TableIndex({ columnNames: ['kri_id'] }));
        await queryRunner.createIndex('kri_risk_links', new typeorm_1.TableIndex({ columnNames: ['risk_id'] }));
        await queryRunner.query(`
...
exports.CreateKRIsTable1702000000006 = CreateKRIsTable1702000000006;
//# sourceMappingURL=1702000000006-CreateKRIsTable.js.map