...
export class ControlLibraryStatsDto {
...
export class ControlLibraryBrowseResponseDto {
  data: UnifiedControl[];
  meta: {
    page: number;
    limit: number;
...
export class ControlDomainTreeNodeDto {
  id: string;
  name: string;
  code?: string;
  controlCount: number;
...
export class ControlDashboardDto {
...
export class ControlEffectivenessDto {
  controlId: string;
  title: string;
...
export class ImportControlsResultDto {
  created: number;
  skipped: number;
