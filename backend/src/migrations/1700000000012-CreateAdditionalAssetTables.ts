...
export class CreateAdditionalAssetTables1700000000012 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Create information_assets table
    ...
    // Add foreign keys for information_assets
    ...
    // Add foreign keys for business_applications
    await queryRunner.createForeignKey(
    ...
    // Add foreign keys for software_assets
    await queryRunner.createForeignKey(
      'software_assets',
      new TableForeignKey({
        columnNames: ['owner_id'],
