...
export class CreateRemediationTrackersTable1701000000102 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createIndex(
      'remediation_trackers',
      new TableIndex({ columnNames: ['finding_id'] }),
    );
    await queryRunner.createIndex(
      'remediation_trackers',
      new TableIndex({ columnNames: ['remediation_priority'] }),
    );
    await queryRunner.createIndex(
      'remediation_trackers',
      new TableIndex({ columnNames: ['sla_due_date'] }),
    );
    await queryRunner.createIndex(
      'remediation_trackers',
      new TableIndex({ columnNames: ['assigned_to_id'] }),
    );
    await queryRunner.createIndex(
      'remediation_trackers',
      new TableIndex({
